...
class HadoopJiraWrapper(JiraWrapper):
  ...
  def get_patches_per_branch(self, issue_id, additional_branches, committed_on_branches):
    ...
    self._map_patches_for_additional_branches(additional_branches, branch_to_patch_dict, committed_on_branches,
                                              issue_id)
  ...
  def _map_patches_for_additional_branches(self, additional_branches, branch_to_patch_dict, committed_on_branches,
                                           issue_id):
    for branch in additional_branches:
      ...
      if not branch_required:
        LOG.info("[%s] Patch should be targeted to additional branch %s, but it is already committed on that branch!",
                 issue_id, branch)
  ...
  def _create_patch_object_from_trunk_filename(self, trunk_search_obj, issue_id, filename, owner, committed_on_branches):
  ...
  def _create_patch_object_from_other_branch_filename(self, sep_char, issue_id, filename, owner, committed_on_branches):
